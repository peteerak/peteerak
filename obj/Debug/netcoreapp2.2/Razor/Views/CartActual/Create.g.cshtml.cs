#pragma checksum "c:\Users\karn_\Documents\kafer\kafer_house\Views\CartActual\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bdc649da50ec099cc832b1cae758b2ded99ca341"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bdc649da50ec099cc832b1cae758b2ded99ca341", @"/Views/CartActual/Create.cshtml")]
...
<script>
    ...
    function product_data_arrived(data) {
        ...
        $.each(data, function (key, item) {
            cmb_product_names.append('<option value=' + item.i");
                WriteLiteral(@"d + '>' + item.name + '</option>');
        });
    ...
    function cb_dec_clicked(){
      ...
      function cb_add_clicked(){
            var product_id = cmb_product_names.val(); //get");
                WriteLiteral(@" selection value
