#pragma checksum "C:\Users\karn_\Documents\kafer\kafer_house\Views\Dashboard\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "209d9d2dabef65a040ab0e7e1cae1372a4f16563"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"209d9d2dabef65a040ab0e7e1cae1372a4f16563", @"/Views/Dashboard/Index.cshtml")]
 ...
 ");
    ...
    <!-- Quick Statistics -->
    <div class=""d-flex justify-content-between align-items-center pt-5 pb-");
            WriteLiteral(@"3"">
    ...
    <div class=""row row-deck"">
        <div class=""col-sm-6 col-xl-3 invisible"" data-toggle=""appea");
            WriteLiteral(@"r"">
        ...
        <div class=""col-sm-6 col-xl-3 invisible"" data-toggle=""appear"" data-timeout=""450"">
            <a class=""block block-rounded block-fx-pop"" href=""javascript:void(0)"">
                <div cla");
            WriteLiteral(@"ss=""block-content block-content-full"">
        ...
        <div class=""col-sm-6 col-xl-3 invisible"" data-toggle=""appear"" data-timeout=""300"">
            <a class=""block block-rounded block-fx-pop"" href=""javascript:void(0)"">
                <div class=""block-content block-content-full"">
                    ...
                    <div class=""t");
            WriteLiteral(@"ext-black font-size-h1 font-w700"">290</div>
                    <div class=""font-size-h4 font-w700 text-success"">
                        <i class=""fa fa-caret-up mr-1""></i>
                        1.2%
                    </div>
...
");
    ...
    <script>
        ...
        $(function () {
            $('#sho");
                WriteLiteral(@"ppingMall_names').change(function () {
        ...
        function render_branch(data) {
            ...
            $.each(data, function (key, item) {
                cmb_branch_names.append('<option value=' + item.id + '>' + item.na");
