#pragma checksum "c:\Users\karn_\Documents\kafer\kafer_house\Views\Dashboard\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "38e8a37bd2abc09a536b2a0e12cef573e0eadbf9"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"38e8a37bd2abc09a536b2a0e12cef573e0eadbf9", @"/Views/Dashboard/Index.cshtml")]
        ...
        <div class=""col-md-4"">
            <div class=""form-group"">
                ...
                <div class=""input-daterange input-group"" data-date-format=""dd/mm/yyyy"" data-week-start=""1"" data-autoclose=""true"" data-today-highlight=""true"">
                    ...
                    <input type=""text"" ");
            WriteLiteral(@"class=""form-control"" id=""date_loss_2"" name=""date_loss_2"" placeholder=""To"" data-week-start=""1"" data-autoclose=""true"" data-today-highlight=""true"">
                </div>
            </div>
        </div>
        <div class=""col-md-2"">
        ...
        function loss_done(data){
            ...
            $.each(filtered, function (key, item) {
                ...
                var total = item.allItems.reduce(function(acc, curr){
                    ...
                    return {productLoss: acc.productLoss + curr.productLoss}
                });

              ");
                WriteLiteral(@"  console.log(total, ""total"")
                    ...
                    '<div class=""block block-rounded mb-1""><div  class=""block-header block-header-default"" role=""tab"" id=""accordion2_h1""><a class=""font-w600"" data-toggle=""collapse"" data-parent=""#accordion2"" href=""#' +  'key' + key  + '""' + 'aria-expanded=""true"" aria-controls=""accordion2_q1"">'
                        ...
                        '</a><a class=""font-w600"" data-toggle=""collapse"" data-parent=""#accordion2"" href=""#' +  'key' + key  + '""' + 'aria-expanded=""true"" aria-controls=""accordion2_q1"">'
                            ...
                            '<div id=""' + 'key' + key  + '"" class=""collapse"" role=""tabpanel"" aria-labelledby=""accordion2_h1""><div class=""block-content""><div class=""table-responsive""><table id=""dataTable"" class=""table table-bordered table-striped table-vcenter""><thead><tr>'
                                + '<th c");
                WriteLiteral(@"lass=""text-center"" style=""width: 50px;"">Product Name</th><th class=""text-center"" >Delivered</th><th class=""text-center"" >Returned</th><th class=""text-center"" >Actual</th><th class=""text-center"" style=""font-weight: bold"">Loss</th></tr></thead>'
                                   + contain
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    fill: !0,
                            ba");
                WriteLiteral(@"ckgroundColor: ""rgba(103, 114, 229, .75)"",
