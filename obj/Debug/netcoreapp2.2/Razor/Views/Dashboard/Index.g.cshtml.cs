#pragma checksum "c:\Users\karn_\Documents\kafer\kafer_house\Views\Dashboard\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2d0a8d5f67eb875d8302c7dd4753b689496584a9"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2d0a8d5f67eb875d8302c7dd4753b689496584a9", @"/Views/Dashboard/Index.cshtml")]
...
");
    ...
    <script>
        ...
        function");
                WriteLiteral(@" render_branch(data) {
            if (data) {
     ...
     ");
                WriteLiteral(@"           dateTo: cmb_date_loss_2.val()
            },
            url: '/dashboard/getdelivery',
            success: getdelivery_done,
            error: function (err) { console.log('error', err); }
            };
            $.post(option); 
        }

        function getdelivery_done(data){
        ...
        function confirm_done(data){
            ...
            cons");
                WriteLiteral(@"ole.log(result, ""result"");
        ...
        var config = {
            ...
            data: {
                ...
                WriteLiteral(@"gba(103, 114, 229, 1)"",
